function onCreate()
	...
	makeLuaSprite('factory-background', 'factory-background', -850, -1180);
	setScrollFactor('factory-background', 1, 1);
    scaleObject('factory-background', 1.1, 1.1);
	...
	addLuaSprite('factory-background', false);
